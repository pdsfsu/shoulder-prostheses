...
afiles = ['a_all.txt', 'ah_all.txt', 'b_all.txt', 'bh_all.txt', 'g_all.txt', 'gh_all.txt', 'h_all.txt', 'n_all.txt', 'o1_all.txt', 'o2_all.txt', 'o3_all.txt']
...
for file in files:
    ...
    r.write('False Negatives: ' + str(fp) + '\n')
